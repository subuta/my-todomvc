...
(function() {
  casper.test.begin("TODOの削除テスト", 8, function(test) {
    ...
    casper.then(function() {
      test.info("タスクを削除したら");
      return casper.waitForSelector('.todo-form-footer-wrapper .todo-form-footer .footer-right .btn-small', function() {
    ...
    casper.then(function() {
      return casper.waitWhileVisible('.todo-form-footer-wrapper .todo-form-footer .footer-right .btn-small', function() {
